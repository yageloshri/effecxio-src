...
<body>
  ...
  <script>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>כשגוללים את הדף, התמונה שבתוך הכרטיס זזה בכיוון ההפוך — וככה נוצרת תחושת עומק, כאילו התמונה נמצאת מאחורי חלון. התמונה קצת יותר גדולה מהכרטיס כדי שיהיה לה מקום לזוז, וסקריפט קטן מחשב לפי מיקום הגלילה כמה להזיז אותה.</p>`,
    proTipHe: 'הוסיפו scale(1.05) קל ב-hover מעל הכרטיס כדי ליצור תחושה שהתמונה מתקרבת אליכם.',
    promptHe: 'אני רוצה אפקט פרלקס תמונה — כרטיסים עם תמונות שזזות בכיוון הפוך לגלילה ויוצרות אשליית עומק. לפני שאתה כותב קוד, תשאל אותי: כמה כרטיסים להציג? מה התמונות שישמשו (URL או placeholder)? מה הגודל של כל כרטיס? מה עוצמת אפקט הפרלקס? האם יש טקסט על הכרטיסים? מה צבע הרקע של הדף? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <div class="clip-card">
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>התמונה מוסתרת מאחורי צורה — עיגול, יהלום או מלבן — ורואים רק חלק קטן ממנה. כשמרחפים עם העכבר, הצורה מתרחבת בצורה חלקה וחושפת את כל התמונה. זה עובד עם תכונת CSS שנקראת clip-path שחותכת את מה שמחוץ לצורה.</p>`,
    proTipHe: 'השתמשו בכלי כמו Clippy (bennettfeely.com/clippy) כדי ליצור צורות clip-path מורכבות בצורה ויזואלית.',
    promptHe: 'אני רוצה אפקט חיתוך תמונה — תמונה שמוסתרת מאחורי צורה (עיגול, יהלום וכו\') ומתגלה ב-hover. לפני שאתה כותב קוד, תשאל אותי: כמה כרטיסים להציג? מה הצורות שרוצים (עיגול, יהלום, מלבן, כוכב)? מה התמונות או הצבעים? מה הגודל של כל כרטיס? האם יש טקסט על הכרטיסים? מה סגנון האנימציה (מהירות, סוג)? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <script>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>יש שתי תמונות אחת מעל השנייה — "לפני" ו"אחרי". קו מחיצה לבן מאפשר לגרור ימינה ושמאלה כדי לחשוף יותר מתמונה אחת או מהשנייה. הסקריפט עוקב אחרי מיקום העכבר או האצבע ומעדכן את החיתוך בהתאם, וזה עובד גם על מובייל.</p>`,
    proTipHe: 'הוסיפו אנימציית bounce קלה למחיצה בטעינה כדי לרמז למשתמש שהיא ניתנת לגרירה.',
    promptHe: 'אני רוצה רכיב השוואת לפני ואחרי — שתי תמונות עם מחיצה שאפשר לגרור כדי לראות את ההבדל. לפני שאתה כותב קוד, תשאל אותי: מה שתי התמונות שישמשו (URL או placeholder)? מה הגודל של הרכיב? האם המחיצה אנכית או אופקית? מה צבע וסגנון קו המחיצה? האם יש תוויות "לפני/אחרי"? האם צריך תמיכה במובייל? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <p class="hint">Hover over the stack</p>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>כמה תמונות מונחות אחת על השנייה כמו חפיסת קלפים. כשמרחפים עם העכבר, הן נפרשות לצדדים כמו מניפה — כל תמונה זזה לכיוון אחר ומסתובבת קצת. כשעוזבים את העכבר, הכל חוזר בחזרה לערימה מסודרת.</p>`,
    proTipHe: 'הוסיפו transition-delay שונה לכל כרטיס כדי ליצור אפקט גל שבו הכרטיסים נפתחים בזה אחר זה.',
    promptHe: 'אני רוצה אפקט מחסנית תמונות — תמונות שמונחות אחת על השנייה ונפרשות כמו מניפה ב-hover. לפני שאתה כותב קוד, תשאל אותי: כמה תמונות במחסנית? מה התמונות (URL או placeholder)? מה הגודל של כל תמונה? באיזה כיוון הן נפרשות (לצדדים, למעלה)? מה זווית הסיבוב? מה צבע הרקע? האם יש טקסט על כל תמונה? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <script>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>כשמרחפים עם העכבר מעל התמונה, היא מתעוותת כאילו מסתכלים עליה דרך מים או גלי חום. האפקט הזה נוצר באמצעות פילטר SVG שמייצר תבנית רעש ומזיז את הפיקסלים של התמונה לפיה. סקריפט קטן משנה את התבנית כל הזמן כדי שהעיוות ייראה כמו תנועה חיה.</p>`,
    proTipHe: 'שלבו את האפקט עם transition על scale ב-hover כדי ליצור תחושה של תמונה שמתעוותת ומתגדלת בו-זמנית.',
    promptHe: 'אני רוצה אפקט עיוות תמונה — תמונה שמתעוותת ב-hover באפקט נוזלי או גלי חום באמצעות פילטרי SVG. לפני שאתה כותב קוד, תשאל אותי: כמה תמונות להציג? מה התמונות (URL או placeholder)? מה הגודל של כל תמונה? מה סוג העיוות (גלי, נוזלי, רעידה)? מה עוצמת העיוות? מה מהירות האנימציה? מה צבע הרקע? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <script>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>תמונות בגדלים שונים מסודרות בפריסת עמודות כמו בפינטרסט. כשלוחצים על תמונה, היא נפתחת בגדול על כל המסך עם אפקט זום חלק. אפשר לסגור את התצוגה המוגדלת בלחיצה על X, על הרקע הכהה, או במקש Escape.</p>`,
    proTipHe: 'הוסיפו חצים לניווט בין תמונות בתוך ה-lightbox כדי ליצור חוויית גלרייה מלאה.',
    promptHe: 'אני רוצה גלריית תמונות בסגנון masonry עם תיבת אור — תמונות בגדלים שונים שנפתחות בגדול בלחיצה. לפני שאתה כותב קוד, תשאל אותי: כמה תמונות בגלרייה? מה התמונות (URL או placeholder)? כמה עמודות? האם יש ניווט בתיבת האור (חצים, מקלדת)? מה גודל התמונה המוגדלת? מה צבע הרקע? האם הגלרייה רספונסיבית? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
...
<body>
  ...
  <script>
    ...
    explanationHe: `<p><strong>מה קורה פה?</strong></p><p>לוחצים על תמונה קטנה והיא נפתחת על כל המסך עם אפקט זום חלק. אפשר לעבור בין תמונות עם חצים בצדדים או עם מקשי החצים במקלדת, ולסגור עם X, לחיצה על הרקע, או Escape. מונה בתחתית מראה באיזו תמונה אתם מתוך הסדרה.</p>`,
    proTipHe: 'הוסיפו preload לתמונות הבאות והקודמות כדי שהניווט יהיה מיידי ובלי עיכובים.',
    promptHe: 'אני רוצה תיבת אור (Lightbox) — לחיצה על תמונה קטנה פותחת אותה בגדול על כל המסך עם ניווט בין תמונות. לפני שאתה כותב קוד, תשאל אותי: כמה תמונות? מה התמונות (URL או placeholder)? מה הגודל של התמונות הקטנות? האם יש ניווט עם חצים ומקלדת? האם יש מונה תמונות? מה אנימציית הפתיחה (זום, פייד, סלייד)? מה צבע הרקע הכהה? תייצר לי את הקוד המלא (HTML + CSS + JavaScript) מוכן להדבקה.',
  },
];
